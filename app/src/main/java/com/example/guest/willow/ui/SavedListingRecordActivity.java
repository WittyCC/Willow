...
public class SavedListingRecordActivity extends AppCompatActivity {
    ...
    private void setUpFirebaseAdapter() {
        mFirebaseAdapter = new FirebaseRecyclerAdapter<Listing, FirebaseListingViewHolder>(Listing.class, R.layout.listing_property_item, FirebaseListingViewHolder.class, mListingReference) {
